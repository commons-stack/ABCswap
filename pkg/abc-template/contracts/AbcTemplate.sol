...
contract AbcTemplate is BaseTemplate, TokenCache {
    ...
    string private constant ERROR_BAD_PAYROLL_SETTINGS = "ABC_BAD_PAYROLL_SETTINGS";
    ...
    function newInstance(
        ...
        _validateId(_id);
        _ensureAbcSettings(_holders, _stakes, _votingSettings);
    ...
    function newInstance(
        ...
        _validateId(_id);
        _ensureAbcSettings(_holders, _stakes, _votingSettings, _payrollSettings);
    ...
    function _setupPayrollApp(
        ...
        (address denominationToken, IFeed priceFeed, uint64 rateExpiryTime, address employeeManager) =
            _unwrapPayrollSettings(_payrollSettings);
    ...
    function _ensureAbcSettings(address[] memory _holders, uint256[] memory _stakes, uint64[3] memory _votingSettings)
        private
        pure
    {
