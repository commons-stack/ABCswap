import { Heading, ListItem, Text, UnorderedList, VStack, Link } from "@chakra-ui/react";
...
export default function PrivacyPolicy() {
    return (
        <VStack px="5%" pb="5%" color="brand.900" spacing={5} alignItems="flex-start" backgroundColor="brand.100">
            ...
            <Text>
                This Privacy Policy, together with our <Link href="https://abcswap.xyz/#/terms"><Text as="u">Terms of Service (“Terms”)</Text></Link> governs the collection and processing of your data and is applicable to all the information collected through the Platforms, upon the use of such Platforms, any related services, marketing, events and/or any other locations that are in any way linked to this Privacy Policy (collectively, the “Services”).
            </Text>
            <Text as="b">
